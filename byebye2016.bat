...
:permission
	...
	echo.    Bummer, looks like you arent the administration.
	echo.    I can't let you run this, sorry.
	echo.
	echo.    Hit up your administrator to remove office 2016.
	echo.
...
:terms
	...
	echo.    This batch file will modifiy files and registries.
	echo.    This has been tested successfully on my personal computer but if 
	echo.    you run into any issues using this I assume no responsibility.
	echo.    I can't be sure that this will be successful for you, so use at your own risk.
	echo.    
	echo.
	echo.    Your AV software might get in the way of this running successfully. Double check
	echo.    before you decide to run this.
	echo. 	 Bye-bye office 2016 see ya never
	echo.
	...
	echo.
	echo.Bummer, there was an error 
	echo.
	echo.Press any key to continue . . .
	pause>nul
goto :eof
